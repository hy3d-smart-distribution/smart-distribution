...
namespace Lean.Touch
{
	...
	public class LeanRotate2 : MonoBehaviour
	{
		...
		protected virtual void Rotate(float twistDegrees)
		{
			...
			if (camera != null)
			{
				var axis = transform.InverseTransformDirection(-transform.forward);

				transform.rotation *= Quaternion.AngleAxis(twistDegrees*0.8f, axis);
			}
		}
	}
}