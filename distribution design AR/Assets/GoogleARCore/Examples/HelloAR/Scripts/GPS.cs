...
public class GPS : MonoBehaviour
{
   ...
   // public Text text_refresh;
...

    {
...

        {
...

            {
                ...
                InvokeRepeating("RetrieveGPSData", 0.0001f, 5.0f);//0.0001초에 실행하고 1초마다 해당 함수를 실행합니다.
...

    {
        ...
        PlayerPrefs.SetString("lat", (currentGPSPosition.latitude * detailed_num).ToString("00.##"));
        PlayerPrefs.SetString("long", (currentGPSPosition.longitude * detailed_num).ToString("000.##"));
        Debug.Log((currentGPSPosition.latitude * detailed_num).ToString("00.##"));
        Debug.Log((currentGPSPosition.longitude * detailed_num).ToString("000.##"));
